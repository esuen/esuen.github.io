...
(function() {
  ...
  // Stories row
  const signalLinks = [
    { id: 'signal-1', label: 'Signal: Ch.1', href: '/astral-rift/stories/signal-1.html', color: '#a0a0b8' },
    { id: 'signal-2', label: 'Ch.2', href: '/astral-rift/stories/signal-2.html', color: '#a0a0b8' },
    { id: 'signal-3', label: 'Ch.3', href: '/astral-rift/stories/signal-3.html', color: '#a0a0b8' },
    { id: 'signal-4', label: 'Ch.4', href: '/astral-rift/stories/signal-4.html', color: '#a0a0b8' },
    { id: 'signal-5', label: 'Ch.5', href: '/astral-rift/stories/signal-5.html', color: '#a0a0b8' },
    { id: 'signal-6', label: 'Ch.6', href: '/astral-rift/stories/signal-6.html', color: '#a0a0b8' },
  ];

  const deeperLinks = [
    { id: 'deeper-1', label: 'Deeper: Ch.1', href: '/astral-rift/stories/deeper-1.html', color: '#4a8eff' },
    { id: 'deeper-2', label: 'Ch.2', href: '/astral-rift/stories/deeper-2.html', color: '#4a8eff' },
    { id: 'deeper-3', label: 'Ch.3', href: '/astral-rift/stories/deeper-3.html', color: '#4a8eff' },
    { id: 'deeper-4', label: 'Ch.4', href: '/astral-rift/stories/deeper-4.html', color: '#4a8eff' },
    { id: 'deeper-5', label: 'Ch.5', href: '/astral-rift/stories/deeper-5.html', color: '#4a8eff' },
    { id: 'deeper-6', label: 'Ch.6', href: '/astral-rift/stories/deeper-6.html', color: '#4a8eff' },
  ];
  ...
  signalRow.style.cssText = 'display: flex; gap: 16px; flex-wrap: wrap; justify-content: center;';
  signalLinks.forEach(item => signalRow.appendChild(makeLink(item)));
  nav.appendChild(signalRow);

  const deeperRow = document.createElement('div');
  deeperRow.style.cssText = 'display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; margin-top: 12px;';
  deeperLinks.forEach(item => deeperRow.appendChild(makeLink(item)));
  nav.appendChild(deeperRow);
})();
